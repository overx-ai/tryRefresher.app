...
export const TECHNIQUES = [
  ...
  { key: 'wim',      page: '/wim-hof-breathing-app', name: 'Wim Hof',            pattern: '3 × 30 + 60/90/90s',   access: 'Included',    ratio: [['inhale',3],['exhale',3],['hold',14]],              when: 'Seated or lying down, never in water. Every number tunable with Premium' },
