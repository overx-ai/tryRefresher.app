...
export const TECHNIQUES = [
  { key: 'box',      name: 'Box',                pattern: '4 · 4 · 4 · 4',        access: 'Included',    ratio: [['inhale',4],['hold',4],['exhale',4],['pause',4]],   when: 'Equal phases, a hold at both ends' },
  { key: '478',      name: '4-7-8',              pattern: '4 · 7 · 8',            access: 'Included',    ratio: [['inhale',4],['hold',7],['exhale',8]],               when: 'The longest exhale of the fixed patterns' },
  { key: 'coherent', name: 'Coherent',           pattern: '5.5 in · 5.5 out',     access: 'Included',    ratio: [['inhale',55],['exhale',55]],                        when: 'Adjustable from 3 to 10 seconds per phase' },
